...
from app.services.content_filter import extract_useful_content # ✨ NAYA IMPORT
import json

async def main_process(pdf_text: str):
    print("\n" + "="*40)
    ...
    filtered_good_chunks = extract_useful_content(chunks)
